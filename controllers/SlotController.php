...
class SlotController extends Controller
{
    ...
    {
        $this->view->params['activeMenuItem'] = 'slot';
    ...
    {
        $dataProvider = $this->slotRepository->dataProvider();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if ($this->slotRepository->create($model)) {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if ($this->slotRepository->update($model)) {
                return $this->redirect(['view', 'id' => $model->id]);
            } else {
    ...
    {
        $model = $this->findModel($id);
        $this->slotRepository->delete($model);
    ...
    {
        if (($model = $this->slotRepository->find($id)) !== null) {
            return $model;
        }
